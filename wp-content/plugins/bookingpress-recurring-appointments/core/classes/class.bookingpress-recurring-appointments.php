...
if (!class_exists('bookingpress_recurring_appointments') && class_exists('BookingPress_Core')) {
    ...
    class bookingpress_recurring_appointments Extends BookingPress_Core {
        ...
        function __construct(){
            ...
            global $bookingpress_pro_version,$default_recurring_appointments_max_no_of_times,$is_cart_addon_active,$all_recurring_frequencies, $bookingpress_uniq_id_recurring_thankyou;
        ...
        */
        function bookingpress_update_recurring_appointment_data(){
            ...
            if( version_compare( $bookingpress_db_recurring_appointments_version, '1.3', '<' ) ){
		...
		*/
         ...
         * @return void
         */
        function bookingpress_get_recurring_appointments_func(){
            ...
            if(!empty($get_possible_date_and_times)){                                
                ...
                /** Holiday Date New Logic Start Here */
                    ...
                    if(empty($bookingpress_selected_service)){
                        $bookingpress_selected_service = $appointment_data_obj['selected_service'];
                    }
            ...
            <div class="bpa-form-body-row bpa-form-body-row-recurring">
                ...
                <el-row :gutter="32">                     
                    <el-col v-if="service.enable_recurring_appointments" :xs="24" :sm="24" :md="24" :lg="8" :xl="8">
                        <el-form-item>
                            <template #label>
                                <span class="bpa-form-label"><?php esc_html_e( 'Recurring Appointments Max No Of Times', 'bookingpress-recurring-appointments' ); ?></span>            
                            </template>
                            <el-input-number class="bpa-form-control bpa-form-control--number" :min="2" :max="50" v-model="service.recurring_appointments_max_no_of_times" id="recurring_appointments_max_no_of_times" name="recurring_appointments_max_no_of_times" step-strictly></el-input-number>                            
                        </el-form-item>
                    </el-col>                   	
                    <el-col v-if="service.enable_recurring_appointments" :xs="24" :sm="24" :md="24" :lg="8" :xl="8">
                        <el-form-item prop="recurring_frequencies">
                            <template #label>
                                    <span class="bpa-form-label"><?php esc_html_e('Recurring Frequencies', 'bookingpress-recurring-appointments' ); ?></span>            
                            </template>                                                
                    ...
                    <el-col v-if="service.enable_recurring_appointments && service.recurring_frequencies.lenght != 0" :xs="24" :sm="24" :md="24" :lg="8" :xl="8">
                        <el-form-item prop="default_recurring_frequencies">
                            <template #label>
                                    <span class="bpa-form-label"><?php esc_html_e('Default Recurring Frequency', 'bookingpress-recurring-appointments' ); ?></span>            
                            </template>                                                
