<div class="bpa-gs__cb--item">
    ...
    <el-row class="bpa-gs--tabs-pb__cb-item-row">
        ...
        <el-col :xs="12" :sm="12" :md="12" :lg="16" :xl="16" class="bpa-gs__cb-item-right">
            <el-form-item prop="bookingpress_selected_whatsapp_gateway">
                <el-select class="bpa-form-control" v-model="notification_setting_form.bookingpress_selected_whatsapp_gateway" filterable placeholder="<?php esc_html_e('Select WhatsApp Gateway', 'bookingpress-whatsapp'); ?>">
    ...
    <el-row class="bpa-gs--tabs-pb__cb-item-row" v-if="notification_setting_form.bookingpress_selected_whatsapp_gateway === 'Twilio'">
        <el-col :xs="12" :sm="12" :md="12" :lg="08" :xl="08" class="bpa-gs__cb-item-left">
            <h4><?php esc_html_e( 'From Number', 'bookingpress-whatsapp' ); ?></h4>
        </el-col> 
        <el-col :xs="12" :sm="12" :md="12" :lg="16" :xl="16" class="bpa-gs__cb-item-right">
            <el-form-item prop="whatsapp_twilio_from_number">
                <el-input class="bpa-form-control" v-model="notification_setting_form.whatsapp_twilio_from_number" placeholder="<?php esc_html_e( 'From Number', 'bookingpress-whatsapp' ); ?>" ></el-input>                       
            </el-form-item>
        </el-col>
    </el-row> 
    <el-row class="bpa-gs--tabs-pb__cb-item-row" >
    ...
    <el-form :model="bookingpress_test_whatsapp_form" :rules="bookingpress_test_whatsapp_rules" ref="bookingpress_test_whatsapp_form">
        <el-row class="bpa-gs--tabs-pb__cb-item-row">
            <el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24">
                <div class="bpa-gs__cb--item-heading">
